...
while rodando:
    ...
    pygame.draw.rect(screen, (255,0,0),retangulo_jogador,1)
    pygame.draw.rect(screen, (255,0,0),retangulo_missil,1)
    pygame.draw.rect(screen, (255,0,0), retangulo_etzin,1)
